...
export default function CmdMenu() {
  ...
  const commands = [
    ...
    {
      id: "stage-2",
      title: "Navigate to CampusConnect",
    ...
    {
      id: "stage-4",
      title: "Navigate to MADHU//OS",
      subtitle: "View 3D operating system environment details",
      icon: <Move size={16} />,
