  ...
  const commands = [
    {
      ...
      subtitle: "Jump to the starting cinematic viewport",
      icon: <Move size={16} />,
      action: () => scrollToSection("hero-section"),
    },
    {
      id: "stage-1",
      title: "Navigate to Works",
      subtitle: "View completed 3D spatial project interfaces",
      icon: <Move size={16} />,
      action: () => scrollToSection("works-section"),
    },
    {
      id: "stage-2",
      title: "Navigate to About",
      subtitle: "Inspect interactive dot-matrix wave field",
      icon: <Move size={16} />,
    ...
    },
    {
      ...
      subtitle: "Access titanium metallic contact node",
      icon: <Move size={16} />,
